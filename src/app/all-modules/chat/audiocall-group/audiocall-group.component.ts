...
declare const $: any;
@Component({
  selector: 'app-audiocall-group',
  templateUrl: './audiocall-group.component.html',
  styleUrls: ['./audiocall-group.component.css']
})
export class AudiocallGroupComponent implements OnInit {
