...
declare const $: any;
@Component({
  selector: 'app-videocall-group',
  templateUrl: './videocall-group.component.html',
  styleUrls: ['./videocall-group.component.css']
})
export class VideocallGroupComponent implements OnInit {
