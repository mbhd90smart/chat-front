...
declare const $: any;
@Component({
  selector: 'app-videocall-single',
  templateUrl: './videocall-single.component.html',
  styleUrls: ['./videocall-single.component.css']
})
export class VideocallSingleComponent implements OnInit {
