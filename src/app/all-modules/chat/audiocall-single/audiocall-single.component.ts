...
declare const $: any;
@Component({
  selector: 'app-audiocall-single',
  templateUrl: './audiocall-single.component.html',
  styleUrls: ['./audiocall-single.component.css']
})
export class AudiocallSingleComponent implements OnInit {
